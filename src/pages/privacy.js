...
const Privacy = () => {
  return (
    <Layout>
      <section class="padding-section" id="datenschutz">
        <div class="container">
          <div class="row">
        ...
        <div class="container">
          <div class="row">
            <div class="column-left">
              ...
              <ul class="flat-list">
                <li>Michael Mitteldorf</li>
                <li>Im Winkel 5</li>
                <li>38176 Wendeburg</li>
                <li>Deutschland</li>
              </ul>
              <ul class="flat-list">
                <li>Telefon: +49 177 5883862</li>
                <li>E-Mail: caveclown(at)web.de</li>
              </ul>
              <p>
              ...
              <p>
                ...
                eingeschränkt haben, dürfen diese Daten &ndash; von ihrer
              ...
              <p>
                ...
                Ihrem Endgerät gespeichert, bis Sie diese selbst
              ...
              <p>
                ...
                nicht funktionieren würden (z.&nbsp;B. die Warenkorbfunktion
                oder die Anzeige von Videos). Andere Cookies dienen dazu, das
              ...
              <p>
                ...
                Optimierung seiner Website &ndash; hierzu müssen die
